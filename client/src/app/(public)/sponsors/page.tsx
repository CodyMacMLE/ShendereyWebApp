                    ...
                    <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                            ...
                            <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                                ...
                                <figure className="relative isolate">
                                    ...
                                    <figcaption className="mt-6 text-sm/6 text-gray-300">
                                        <strong className="font-semibold text-white">{SponsorsQuote.name},</strong> {SponsorsQuote.position} at Shenderey
                                    </figcaption>
                                </figure>
                            </div>
                        </div>
                        <div>
                            <div className="text-base/7 text-gray-700 lg:max-w-lg">
                                <p className="text-base/7 font-semibold text-[var(--primary)]">Our Sponsors</p>
                                <h1 className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Grateful for Our Sponsors</h1>
                                <div className="max-w-xl">
                                    <p className="mt-6">
                                        At Shenderey Gymnastics, we are deeply grateful for the generous support of our sponsors. Their commitment plays a vital role 
                                        in helping us provide a high-quality, safe, and enriching environment for our athletes.
                                    </p>
                                    <p className="mt-6">
                                        Our sponsors make it possible for gymnasts to pursue their passion and strive for excellence, both in training and in competition. 
                                        Thanks to their contributions, we can continue to offer state-of-the-art equipment, specialized programs, and unforgettable 
                                        experiences that shape each athlete&apos;s journey. Together, we are building a community where dreams are supported and success is 
                                        celebrated. 
                                    </p>
                                </div>
                            </div>
                            <dl className="mt-10 grid grid-cols-2 gap-8 border-t border-gray-900/10 pt-10 sm:grid-cols-3">
                                <div>
                                    <dt className="text-sm/6 font-semibold text-gray-600">Sponsors</dt>
                                    <dd className="mt-2 text-3xl/10 font-bold tracking-tight text-gray-900">{numSponsors}</dd>
                                </div>
                                <div>
                                    <dt className="text-sm/6 font-semibold text-gray-600">Affiliates</dt>
                                    <dd className="mt-2 text-3xl/10 font-bold tracking-tight text-gray-900">{affiliates.length}</dd>
                                </div>
