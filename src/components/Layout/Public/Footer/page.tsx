...
const navigation = {
    ...
    Programs: [
      { name: 'Recreational', href: '/recreational' },
  ...
  export default function Footer() {
    return (
      <footer className="bg-white">
        <div className="mx-auto max-w-7xl px-6 py-10 sm:py-24 lg:px-8 lg:py-5">
          <div className="mt-24 border-t border-gray-900/10 pt-12 xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm/6 font-semibold text-gray-950">About</h3>
                ...
                <div className="mt-10 md:mt-0">
                  <h3 className="text-sm/6 font-semibold text-gray-950">Programs</h3>
                  <ul role="list" className="mt-6 space-y-4">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm/6 font-semibold text-gray-950">Community</h3>
                  <ul role="list" className="mt-6 space-y-4">
                ...
                <div className="mt-10 md:mt-0">
                  <h3 className="text-sm/6 font-semibold text-gray-950">Recruitment</h3>
                  <ul role="list" className="mt-6 space-y-4">
                ...
                <div className="mt-10 md:mt-0">
                  <h3 className="text-sm/6 font-semibold text-gray-950">Media</h3>
                  <ul role="list" className="mt-6 space-y-4">
