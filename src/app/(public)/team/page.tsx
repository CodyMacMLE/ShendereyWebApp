...
const REGIONAL_LEVELS = ['Xcel Gold', 'Xcel Silver', 'Xcel Bronze', 'Xcel Platinum', '1', '2'];

type AthleteCategory = 'national' | 'provincial' | 'regional';
...
function getCategory(level: string | null | undefined): AthleteCategory | null {
    ...
    if (REGIONAL_LEVELS.includes(trimmed)) return 'regional';
    return null;
}
...
export default async function Team() {
    ...
    const regionalAthletes = currentTeam.filter((a) => getCategory(a.athlete?.level) === 'regional');
