                    ...
                    >
                        {seniorStaff.map((person: StaffData) => (
                            <li key={person.user.id} className="flex flex-col gap-6 xl:flex-row">
                                <Image alt="" src={person.staffUrl || '/logos/sg_logo.png'} className={`aspect-[4/5] w-52 flex-none rounded-2xl object-cover max-h-[300px] ${!person.staffUrl ? '' : ''}`} width={600} height={300} style={{ objectFit: 'cover' }}/>
                    ...
                    >
                        {juniorStaff.map((coach: StaffData) => (
                            <li key={coach.user.id}>
                                <Image alt="" src={coach.staffUrl || '/logos/sg_logo.png'} className={`mx-auto size-24 rounded-full ${!coach.staffUrl ? '' : ''}`} width={100} height={100} style={{ objectFit: 'cover', objectPosition: 'top'}}/>
